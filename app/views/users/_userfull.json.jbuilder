...
if defined? sensitive
  json.extract! user, :unread_notifications_count,:access_token,:tw_access_token,:tw_access_token_secret,:tumblr_access_token,:tumblr_access_token_secret,:iphone_device_token 
  json.sensitive true
end
