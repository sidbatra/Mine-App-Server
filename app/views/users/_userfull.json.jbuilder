json.extract! user, :id,:handle,:first_name,:last_name,:gender,:square_image_url,:large_image_url,:byline,:email,:age,:purchases_count,:followings_count,:inverse_followings_count,:is_mining_purchases
